...
public class MPU9250 extends I2CUpdatableAddress {
	...
	/**
	 * Last angle value, in degrees, retrieved from the accelerometer, for the x axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	 */
	...
	/**
	 * Last angle value, in degrees, retrieved from the accelerometer, for the y axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	 */
	...
	/**
	 * Last angle value, in degrees, retrieved from the accelerometer, for the z axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	 */
	...
	/**
	 * Last angular speed value, in degrees/sec, retrieved from the gyroscope, for the x
	 * axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	...
	/**
	 * Last angular speed value, in degrees/sec, retrieved from the gyroscope, for the y
	 * axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	...
	/**
	 * Last angular speed value, in degrees/sec, retrieved from the gyroscope, for the z
	 * axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	...
	/**
	 * Last angle value, in degrees, calculated from the accelerometer and the gyroscope,
	 * for the x axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	 ...
	 * @param dlpfCfg
	 *            the value of the DLPF setting.
	 * @param smplrtDiv
	 *            the value of the sample rate divider.
	 */
	 ...
	 * 
	 * @param dlpfConfig
	 *            the new DLPF_CFG value. Must be in the [0; 7] range, where 0 and 7
	 *            are used to disable the DLPF.
	 */
	...
	/**
	 * Get the last acceleration values, in deg, retrieved from the accelerometer, for
	 * the x, y and z axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	...
	/**
	 * Get the last angle values, in deg, retrieved from the accelerometer, for the x,
	 * y and z axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	...
	/**
	 * Get the last angles values, in deg, retrieved from the gyroscope, for the x, y
	 * and z axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	...
	/**
	 * Last angle value, in deg, calculated from the accelerometer and the gyroscope,
	 * for the x, y and z axis.
	 * <p>
	 * <i>(using the updating thread)</i>
	 * </p>
	 * 
	 * @return the angles values, in deg, filtered with values from the accelerometer
	 *         and the gyroscope.
	 */
	 ...
	 * 
	 * @param address
	 *            the address of the register to update.
	 * @param value
	 *            the new value to set in the register.
	 */
	public void updateRegisterValue(int address, int value) {
		...
		if (data[0] != value)
			Robot.robotLogger.log(Logger.WARNING, this, "Error when updating the MPU9250 register value(register: "
	...
	/**
	 * Returns the String representation of an angular speed value, in the
	 * "x.xxxx deg/s" format.
	 * 
	 * @param angularSpeed
	 *            the angular speed to convert.
	 * @return the String representation of an angular speed value, in the
	 *         "x.xxxx deg/s" format.
	 */
